 ...
 */
function liquidFillGaugeDefaultSettingsAlc(){
    return {
        minValue:0, // The gauge minimum value.
        maxValue: 258.85, // The gauge maximum value.
        circleThickness: 0.00, // The outer circle thickness as a percentage of it's radius.
...
function loadLiquidFillGaugeAlc(elementId, value, config) {
	
	
                                    
//var elem=svgContainer.append("#" + elementId);
    ...
    var imgBack=gaugeGroup.append("image")
    		.attr("xlink:href", "beer3.png")
    		.attr("id","imgBack")
    		.attr("width", 200)
    		.attr("height", 200).append("path")
...
//BMI Scale/Grid
    ...
    /*var back= d3.select("body")
    .append("svg").attr("style", "background-color : black")
    .append(gauge*/
